...
;!function (e) {
    ...
    o.modules = {}, o.status = {}, o.timeout = 10, o.event = {}, t.fn.define = function (e, t) {
        ...
        var p = n.createElement("script"), h = (u[m] ? d + "lay/" : o.base || "") + (f.modules[m] || m) + ".js";
        ...
        "string" == typeof t && (i = t);
        var s = (i || e).replace(/\.|\//g, ""), c = u.id = "layuicss-" + s, f = 0;
        ...
        var i = this, r = null, l = t.match(/\(.*\)$/) || [], u = (t = e + "." + t).replace(l, ""), a = function (e, t) {
            var o = t && t.call(i, n);
            o === !1 && null === r && (r = !1)
        };
