...
var uigs_clpingbackurl = "http://pb.sogou.com/cl.gif", uigs_pvpingbackurl = "http://pb.sogou.com/pv.gif", uigs_version = "v1.9.4", uigs_staytime = (new Date).getTime();
...
var uigs_judgeBottom = function () {
    try {
        var a = uigs_iecompattest().clientHeight, b = uigs_iecompattest().scrollHeight, c = uigs_iecompattest().scrollTop;
        100 < c && 100 > b - a - c && !uigs_al && (uigs_al = !0, a = "", b = uigs_staytime, 0 > uigs_staytime && (b = 0 - uigs_staytime), a = "tob=" + parseInt(((new Date).getTime() - b) / 1E3), uigsPB(a))
    } catch (d) {
    }
};
